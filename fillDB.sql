...
insert into t_food values(DEFAULT, 'BigMac', 3, 2, 1, 'https://firebasestorage.googleapis.com/v0/b/foodwayz-e9a26.appspot.com/o/images%2Ffoods%2FBigMac.jpg?alt=media&token=91942492-25c1-47b8-ae13-840a0d51c779');
insert into t_food values(DEFAULT, 'Burrito de Fideos', 5, 5, 6, 'https://firebasestorage.googleapis.com/v0/b/foodwayz-e9a26.appspot.com/o/images%2Ffoods%2FBurritoDeFideos.jpg?alt=media&token=e1f1d51c-345c-4ad8-b2d2-a1473da64854');
insert into t_food values(DEFAULT, 'Kangreburger', 5, 2, 8, 'https://firebasestorage.googleapis.com/v0/b/foodwayz-e9a26.appspot.com/o/images%2Ffoods%2FCangreBurger.jpg?alt=media&token=6ac4357e-7e06-418b-81d4-b00568b82a6d');
insert into t_food values(DEFAULT, 'Crispy Burger', 2, 2, 2, 'https://firebasestorage.googleapis.com/v0/b/foodwayz-e9a26.appspot.com/o/images%2Ffoods%2FCrispyBurger.jpg?alt=media&token=0733845d-8f24-4dbd-a305-6e3f6bd23522');
insert into t_food values(DEFAULT, 'Ensalada De Kansas', 3, 4, 3, 'https://firebasestorage.googleapis.com/v0/b/foodwayz-e9a26.appspot.com/o/images%2Ffoods%2FEnsalada1.jpg?alt=media&token=03fab50a-7eef-48b6-b594-00997cb73eff');
insert into t_food values(DEFAULT, 'Ensalada Blen', 4, 4, 8, 'https://firebasestorage.googleapis.com/v0/b/foodwayz-e9a26.appspot.com/o/images%2Ffoods%2FEnsaladaBlen.jpg?alt=media&token=ef664121-4240-4548-8316-469be60c4965');
insert into t_food values(DEFAULT, 'Guiso de Lentejas', 5, 1, 6, 'https://firebasestorage.googleapis.com/v0/b/foodwayz-e9a26.appspot.com/o/images%2Ffoods%2FGuisoDeLentejas.jpg?alt=media&token=9c673f75-29ac-49c1-b4dd-d0c683ec2b0f');
insert into t_food values(DEFAULT, 'Guiso de Papa', 2, 1, 4, 'https://firebasestorage.googleapis.com/v0/b/foodwayz-e9a26.appspot.com/o/images%2Ffoods%2FGuisoDePapa.jpg?alt=media&token=c77632df-0293-4a6c-bfec-697412071ca8');
insert into t_food values(DEFAULT, 'Hawaian Stake', 3, 7, 3, 'https://firebasestorage.googleapis.com/v0/b/foodwayz-e9a26.appspot.com/o/images%2Ffoods%2FHawaianStake.jpg?alt=media&token=53510f3a-5283-4737-aee3-3b6c3a536d1b');
insert into t_food values(DEFAULT, 'Kansas Ribs', 3, 7, 3, 'https://firebasestorage.googleapis.com/v0/b/foodwayz-e9a26.appspot.com/o/images%2Ffoods%2FKansasRibs.jpg?alt=media&token=bcc0f048-3287-4fe0-ac9b-2e186057f792');
insert into t_food values(DEFAULT, 'Nigiris de Camaron', 3, 6, 5, 'https://firebasestorage.googleapis.com/v0/b/foodwayz-e9a26.appspot.com/o/images%2Ffoods%2FNigirisDeCamaron.jpg?alt=media&token=14c458f4-18b1-4371-88d4-dcb68ac20256');
insert into t_food values(DEFAULT, 'NYC Phila', 4, 6, 5, 'https://firebasestorage.googleapis.com/v0/b/foodwayz-e9a26.appspot.com/o/images%2Ffoods%2FSushi1.jpg?alt=media&token=1836f52c-6ad4-48c7-8c44-9a99ae73102b');
insert into t_food values(DEFAULT, 'Triple Taco', 5, 5, 6, 'https://firebasestorage.googleapis.com/v0/b/foodwayz-e9a26.appspot.com/o/images%2Ffoods%2FTripleTaco.jpg?alt=media&token=aedb2c3e-73c2-49c5-8ec7-1b4e1e2f0e21');
select * from t_food;
